...
ggplot( data = EXR8.2.2_M, aes(x = GROUP, y = BMD) )  + geom_boxplot() + 
  ...
  geom_jitter(height= .2, width = .2, color="blue", alpha=0.6) + theme_ipsum()
#
...
A physical therapist wished to compare three methods for teaching patients to use a certain prosthetic device. He felt that the rate of learning would be different for patients of different ages and wished to design an experiment in which the influence of age could be taken into account.  
...
ggplot(data = Learn, aes(x = Age, y = Rate) )  + geom_boxplot() + 
  scale_fill_viridis(discrete = TRUE, alpha=0.6) +
  geom_jitter(height= .2, width = .2, color="blue", alpha=0.6) + theme_ipsum()

# For the Rate group
ggplot(data = Learn, aes(x = Method, y = Rate) )  + geom_boxplot() + 
  scale_fill_viridis(discrete = TRUE, alpha=0.6) +
  geom_jitter(height= .2, width = .2, color="blue", alpha=0.6) + theme_ipsum()
...
ggplot( data = Exa8.4.1, aes(x = Time, y = Assessment) ) + 
  geom_boxplot() + 
  scale_fill_viridis(discrete = TRUE, alpha = 0.6) +
  geom_jitter(height = .2, width = .2, color = "blue", alpha = 0.6)
...
ggplot( data = Exa8.4.1, aes(x = Time, y = Assessment) ) + 
  ...
  geom_jitter(height = .2, width = .2, color = "blue", alpha=.6)
