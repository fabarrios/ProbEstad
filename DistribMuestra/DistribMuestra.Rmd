...
2. Si el promedio y la desviación estándar para los valores de hierro en suero de hombres sanos es de $120$ y $15 \mu g$ por $100ml$, respectivamente, cual es la probabilidad de que una muestra al azar de 50 hombres normales sanos resulte en un promedio entre 115 y 125 micro gramos por $100 ml$?  
La respuesta es la diferencia de las probabilidades de $X$ menor o igual a $125$ y $X$ mayor o igual a $115$, es decir $P(X\leq 125) - P(X \leq 115)$ claro que con la distribución normal con la desviación estándar escalada a la muestra de $n=50$.  
```{r}
