...
1. Análisis de gases arteriales de 15 sujetos activos físicamenete resultaron los siguientes datos de valores para `PaO_2`,  `c(75,80,80,74,84,78,89,72,83,76,75,87,78,79,88)`, estime el intervalo de conianza al 95 por ciento para el promedio de la población.  
...
4. El medicamento A fue recetado aleatoriamente a una muetra de 12 sujetos que adolecian de insomnio. Una muestra independiente de 16 pacientes con el mismo problema de insomnio recibieron el medicamento B.  El número de horas de sueño que experimentaron los pacientes durante la seguna noche después del inicio del tratamiento se listan en el archivo `REV_C06_23.csv'. Construya el intervalo de confianza al 95 por ciento de la diferencia del promedio de las poblaciones, suponiendo que las varianzas de las poblaciones son iguales.  
