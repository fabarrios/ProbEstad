...
*Respuesta* Si la cirugía incrementa la función biliar, esto es incrementa GBEF, $\mu_{POSTOP} > \mu_{PREOP}$, es decir queremos demostrar que la diferencia en GBEL (PREOP - POSTOP) es negativa. Por lo tanto, la hipótesis nula es que $H_0: \mu_{PREOP - POSTOP} \leq 0$ y por lo tanto $H_A: \mu_{PREOP - POSTOP} > 0$
