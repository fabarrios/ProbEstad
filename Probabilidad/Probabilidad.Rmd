...
**Respuesta** Este es un grupo de 318 sujetos (muestra) y de la muestra completa, menores o de 18 son 141 (como menores y 18 es excluyente de mayores a 18), la probabilidad es el numero de sujetos en (debut Temprano)/total de sujetos de la muestra  
...
**Pregunta** Supongamos que escogemos un sujeto de la muestra de los 318 sujetos y resulta que es de 18 años o más joven pertenece a la columna $(E)$, Cual es la probabilidad de que este sujeto pertenezca a una familia que no tiene historial de Trastornos Afectivos $(A)$?  
...
$$ P(A \cap B) = P(B)P(A \mid B),\hspace{10pt} \verb+si + P(B) \neq 0$$  
