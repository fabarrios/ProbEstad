...
**Definición** Si algún proceso se repite un número grande de veces, $n$, y si alguno evento resultante de característica $E$ ocurre $m$ veces, la frecuencia relativa de ocurrencia de $E$, $m/n$, será aproximadamente igual a $P(E) = \frac{m}{n}$.  
...
**Respuesta** Este es una grupo de 318 sujetos (muestra) y de la muestra completa de 18 o menores son 141 (como menores y 18 es excluyente de mayores a 18), la probabilidad es numero de sujetos en (debut Temprano)/total de sujetos de la muestra
$$ P(E) =141/318 = 0.4434 $$  

## Probabilidad Condicional  
Cuando la probabilidad se calcula con la frecuencia de un sub-grupo del total de la muestra como la escala, la probabilidad es *condicional*, en este ejemplo que acabamos de estimar, se puedes decir que la probabilidad es incondicional ya que se usó el total de la muestra para estimar la probabilidad. Pero si restringimos la escala (el tamaño del denominador) para estimar la probabilidad se dice que es una *probabilidad marginal* ya que los totales marginales de la muestra son los que se usan.  
...
Cuando dos eventos no so mutuamente excluyentes la probabilidad se calcula por medio de la regla de la adición  
...
**Ejemplo** Si seleccionamos de forma aleatoria de los 318 sujetos de la **Tabla 1**, cual es la probabilidad de que esta persona pertenezca al grupo de debut temprano de Trastornos Afectivos $(E)$ o pertenezca al grupo de familia sin historial de Trastornos Afectivos $(A)$ o ambos?  
